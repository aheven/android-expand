...
public class SkinCompatManager extends SkinObservable {
    ...
    /**
     * 初始化换肤框架. 通过该方法初始化，应用中Activity需继承自SkinCompatActivity.
     *
     * @param context
     * @return
     */
    ...
    /**
     * 初始化换肤框架，监听Activity生命周期. 通过该方法初始化，应用中Activity无需继承SkinCompatActivity.
     *
     ...
     *
     * @param inflater 在{@link SkinCompatViewInflater#createView(View, String, Context, AttributeSet)}方法中调用.
     * @return
     */
     ...
     * 自定义View换肤时，可选择添加一个{@link SkinLayoutInflater}
     *
     * @param inflater 在{@link SkinCompatViewInflater#createView(View, String, Context, AttributeSet)}方法中最先调用.
     * @return
     */
    @Deprecated
