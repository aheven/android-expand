...
class HeaderStateView constructor(
    private val contentView: View
) {
    lateinit var decorView: View private set
    private lateinit var currentViewType: Any
    ...
    init {
        poolInitializer?.apply { PoolInitializer(this@HeaderStateView).invoke() }
    ...
    fun addChildHeaders(vararg delegates: ViewDelegate) =
        addChildDecorView(LinearDecorViewDelegate(delegates))
    ...
    class PoolInitializer internal constructor(private val stateView: HeaderStateView) {
